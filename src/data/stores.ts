...
export const STORES: Store[] = [
  ...
  // ─── Other Kroger-owned banners (share Plus Card + same Developer API) ───
  { id: 'fredmeyer',    name: 'Fred Meyer',     color: '#003DA5', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'ralphs',       name: 'Ralphs',         color: '#E32726', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'kingsoopers',  name: 'King Soopers',   color: '#0062A0', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'frys',         name: "Fry's Food",     color: '#0062A0', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'smiths',       name: "Smith's",        color: '#005DA9', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'qfc',          name: 'QFC',            color: '#E31837', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'marianos',     name: "Mariano's",      color: '#0062A0', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'pickn',        name: 'Pick \'n Save',  color: '#E31837', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'dillons',      name: 'Dillons',        color: '#0062A0', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
  { id: 'citymarket',   name: 'City Market',    color: '#0062A0', icon: '🛒', barcodeSymbology: 'code128', supportsPhone: true },
