...
export const STORE_LOCATIONS: StoreLocation[] = [
  ...
  { id: 'harristeeter-stafford-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '519 Garrisonville Rd, Stafford, VA 22554', lat: 38.4836, lng: -77.4099 },
  { id: 'harristeeter-fredericksburg-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '1885 Carl D Silver Pkwy, Fredericksburg, VA 22401', lat: 38.2937, lng: -77.5225 },
  { id: 'harristeeter-fredericksburg-2', chainId: 'harristeeter', name: 'Harris Teeter', address: '4250 Plank Rd, Fredericksburg, VA 22407', lat: 38.2807, lng: -77.5314 },
  { id: 'harristeeter-stafford-2', chainId: 'harristeeter', name: 'Harris Teeter', address: '5 Town Centre Blvd, Stafford, VA 22556', lat: 38.4625, lng: -77.4138 },
  { id: 'harristeeter-springfield-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '6244 Rolling Rd, Springfield, VA 22152', lat: 38.7785, lng: -77.2284 },
  { id: 'harristeeter-fairfax-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '11054 Lee Hwy, Fairfax, VA 22030', lat: 38.8650, lng: -77.3413 },
  { id: 'harristeeter-burke-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '5821 Burke Centre Pkwy, Burke, VA 22015', lat: 38.7913, lng: -77.2868 },
  { id: 'harristeeter-mclean-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '1445 Chain Bridge Rd, McLean, VA 22101', lat: 38.9341, lng: -77.1762 },
  { id: 'harristeeter-vienna-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '8201 Tysons Corner Center, Tysons, VA 22102', lat: 38.9180, lng: -77.2227 },
  { id: 'harristeeter-leesburg-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '525 E Market St, Leesburg, VA 20176', lat: 39.1132, lng: -77.5478 },
  { id: 'harristeeter-ashburn-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '43330 Junction Plaza, Ashburn, VA 20147', lat: 39.0438, lng: -77.4864 },
  { id: 'harristeeter-reston-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '11651 Reston Pkwy, Reston, VA 20191', lat: 38.9586, lng: -77.3419 },
  { id: 'harristeeter-herndon-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '13360 Franklin Farm Rd, Herndon, VA 20171', lat: 38.9311, lng: -77.4040 },
  { id: 'harristeeter-alexandria-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '3690 King St, Alexandria, VA 22302', lat: 38.8197, lng: -77.0987 },
  { id: 'harristeeter-alexandria-2', chainId: 'harristeeter', name: 'Harris Teeter', address: '500 N Van Dorn St, Alexandria, VA 22304', lat: 38.8207, lng: -77.1284 },
  { id: 'harristeeter-woodbridge-1', chainId: 'harristeeter', name: 'Harris Teeter', address: '14041 Worth Ave, Woodbridge, VA 22192', lat: 38.6627, lng: -77.2935 },
